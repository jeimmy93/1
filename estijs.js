...
var debug = "";
 ...
 var letraJ = [[0,0], [200, 0], [200, 20], [110, 20], [110, 200], [0, 200], 
 	...
 	var letraC = [[0,0], [200, 0], [200, 0], [200, 20],[30,20],[30,160],[200,160],[200, 160],[200, 180],[200,200],[0,200],[0,0]];
 	//var letrai = [[0,0], [20, 0], [20, 0], [20, 200],[20,200],[0,200],[0,0]];

 
 	
 	
 	var continua = dibujar.polyline(letraJ).fill("none").stroke({width : 4, color: '#009900'}).attr({ fill: color });
